...
int main()
{
  ...
  if (length > *widthPtr)// Fill in the condition length > width by using only the pointer variables
  printf("The length is greater than the width\n");
  else if (width > *lengthPtr)// Fill in the condition of width > length by using only the pointer variables
